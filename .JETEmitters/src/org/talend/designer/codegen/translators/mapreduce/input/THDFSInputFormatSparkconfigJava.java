...
public class THDFSInputFormatSparkconfigJava
{
  ...
  protected final String TEXT_128 = NL + "                org.apache.spark.api.java.JavaPairRDD<NullWritable, ";
  protected final String TEXT_129 = "> rdd_";
  protected final String TEXT_130 = " = ctx" + NL + "                                .hadoopRDD(" + NL + "                                        job,";
  protected final String TEXT_131 = NL + "                                        ";
  protected final String TEXT_132 = "StructInputFormat.class," + NL + "                                        NullWritable.class,";
  protected final String TEXT_133 = NL + "                                        ";
  protected final String TEXT_134 = ".class);";
  protected final String TEXT_135 = NL + "            final String clouderaManagerPassword = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_136 = ");";
  protected final String TEXT_137 = NL + "            final String clouderaManagerPassword = ";
  protected final String TEXT_138 = ";";
  protected final String TEXT_139 = NL + "        this.lineageCreator = new org.talend.lineage.cloudera.LineageCreator(";
  ...
  protected final String TEXT_147 = "," + NL + "                clouderaManagerPassword," + NL + "                jobName + \"_\" + jobVersion.replace(\".\", \"_\")," + NL + "                projectName,";
  ...
  protected final String TEXT_154 = NL + "            System.setProperty(\"atlas.conf\", ";
  protected final String TEXT_155 = ");";
  protected final String TEXT_156 = NL + "                String decryptedAtlasUserPassword = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_157 = ");";
  protected final String TEXT_158 = NL + "                String decryptedAtlasUserPassword = ";
  protected final String TEXT_159 = ";";
  protected final String TEXT_160 = NL + "            this.lineageCreator = new org.talend.lineage.atlas.AtlasLineageCreator(";
  protected final String TEXT_161 = ", ";
  protected final String TEXT_162 = ", decryptedAtlasUserPassword);";
  protected final String TEXT_163 = NL + "            this.lineageCreator = new org.talend.lineage.atlas.AtlasLineageCreator(";
  protected final String TEXT_164 = ");";
  protected final String TEXT_165 = NL + "        java.util.Map<String, Object> lineageCreatorJobMetadata = new java.util.HashMap<String, Object>();" + NL + "        lineageCreatorJobMetadata.put(\"name\", jobName);" + NL + "        lineageCreatorJobMetadata.put(\"description\", jobName);" + NL + "        lineageCreatorJobMetadata.put(\"purpose\", \"Talend BigData Job\");" + NL + "        lineageCreatorJobMetadata.put(\"author\", System.getProperty(\"user.name\"));" + NL + "        lineageCreatorJobMetadata.put(\"version\", jobVersion);" + NL + "        lineageCreatorJobMetadata.put(\"jobType\", \"Talend BigData Job\");" + NL + "        lineageCreatorJobMetadata.put(\"framework\", \"Talend BigData\");" + NL + "        lineageCreatorJobMetadata.put(\"status\", \"FINISHED\");" + NL + "        lineageCreatorJobMetadata.put(\"creationDate\", System.currentTimeMillis());" + NL + "        lineageCreatorJobMetadata.put(\"lastModificationDate\", System.currentTimeMillis());" + NL + "        lineageCreatorJobMetadata.put(\"startTime\", System.currentTimeMillis());" + NL + "        lineageCreatorJobMetadata.put(\"endTime\", System.currentTimeMillis());" + NL + "" + NL + "        this.lineageCreator.addJobInfo(lineageCreatorJobMetadata);";
