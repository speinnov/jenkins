...
public class TSAPDataSourceOutputBeginJava
{
  protected static String nl;
  public static synchronized TSAPDataSourceOutputBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSAPDataSourceOutputBeginJava result = new TSAPDataSourceOutputBeginJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_76 = NL + "\torg.talend.sap.impl.bw.SAPBWDataRequest dataRequest_";
  protected final String TEXT_77 = " = new org.talend.sap.impl.bw.SAPBWDataRequest();" + NL + "\tdataRequest_";
  protected final String TEXT_78 = ".setDataSourceName(";
  protected final String TEXT_79 = ");" + NL + "\t" + NL + "\tdataRequest_";
  protected final String TEXT_80 = ".setDataSourceType(org.talend.sap.model.SAPDataSourceType.";
  protected final String TEXT_81 = ");" + NL + "\t" + NL + "\t";
  protected final String TEXT_82 = NL + "\tdataRequest_";
  protected final String TEXT_83 = ".setId(";
  protected final String TEXT_84 = ");" + NL + "\t";
  protected final String TEXT_85 = NL + "\t" + NL + "\t";
  protected final String TEXT_86 = NL + "\tdataRequest_";
  protected final String TEXT_87 = ".setPackageSize(";
  protected final String TEXT_88 = ");" + NL + "\t";
  protected final String TEXT_89 = NL + "\t" + NL + "\t";
  protected final String TEXT_90 = NL + "\tdataRequest_";
  protected final String TEXT_91 = ".setSourceSystemName(";
  protected final String TEXT_92 = ");" + NL + "\t";
  protected final String TEXT_93 = NL + "\t" + NL + "\t";
  protected final String TEXT_94 = NL + "\tjava.text.SimpleDateFormat format_";
  protected final String TEXT_95 = " = new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\");" + NL + "\t";
  protected final String TEXT_96 = NL + "\t" + NL + "\torg.talend.sap.bw.ISAPBWTableDataWritable data_";
  protected final String TEXT_97 = " = dataService_";
  protected final String TEXT_98 = ".createDataSourceRequest(dataRequest_";
  protected final String TEXT_99 = ")";
  protected final String TEXT_100 = NL + "\t\t.addField(\"";
  protected final String TEXT_101 = "\")";
  protected final String TEXT_102 = NL + NL + "\t";
  protected final String TEXT_103 = NL + "\t\t.dataSelection(format_";
  protected final String TEXT_104 = ".parse(";
  protected final String TEXT_105 = "))" + NL + "\t";
  protected final String TEXT_106 = NL + "\t\t" + NL + "\t\t.writable();";
  ...
  public String generate(Object argument)
  {
	...
	String package_size = ElementParameterParser.getValue(node, "__PACKAGE_SIZE__");
	String source_system_name = ElementParameterParser.getValue(node, "__SOURCE_SYSTEM_NAME__");
	String selection_date = ElementParameterParser.getValue(node, "__SELECTION_DATE__");
    ...
    if(parameterUtil.isValid(package_size)) {
    stringBuffer.append(TEXT_86);
    stringBuffer.append(cid);
    stringBuffer.append(TEXT_87);
    stringBuffer.append(package_size);
    stringBuffer.append(TEXT_88);
    }
    stringBuffer.append(TEXT_89);
    if(parameterUtil.isValid(source_system_name)) {
    stringBuffer.append(TEXT_90);
    stringBuffer.append(cid);
    stringBuffer.append(TEXT_91);
    stringBuffer.append(source_system_name);
    stringBuffer.append(TEXT_92);
    }
    stringBuffer.append(TEXT_93);
    if(parameterUtil.isValid(selection_date)) {
    ...
    stringBuffer.append(selection_date);
