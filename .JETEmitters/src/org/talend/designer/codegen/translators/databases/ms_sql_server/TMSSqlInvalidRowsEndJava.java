...
public class TMSSqlInvalidRowsEndJava
{
  protected static String nl;
  public static synchronized TMSSqlInvalidRowsEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMSSqlInvalidRowsEndJava result = new TMSSqlInvalidRowsEndJava();
    nl = null;
    return result;
  }
