...
public class TPartitionSparkcodeJava
{
  ...
  protected final String TEXT_92 = NL + "    \tpublic static class NaturalComparator_";
  protected final String TEXT_93 = " implements Serializable, java.util.Comparator<";
  protected final String TEXT_94 = "> {" + NL + "    \t\tpublic int compare(";
  protected final String TEXT_95 = " arg0, ";
  protected final String TEXT_96 = " arg1) {";
  protected final String TEXT_97 = NL + "    \t\t\t\t\tint compResult = 0;";
  protected final String TEXT_98 = NL + "    \t\t\t\t\tcompResult = arg0._";
  protected final String TEXT_99 = "().compareTo(arg1._";
  protected final String TEXT_100 = "());" + NL + "    \t\t\t\t\tif(compResult != 0) return compResult;";
  protected final String TEXT_101 = NL + "    \t\t\t\treturn 0;";
  protected final String TEXT_102 = NL + "    \t\t\t\treturn arg0._1().compareTo(arg1._1());";
