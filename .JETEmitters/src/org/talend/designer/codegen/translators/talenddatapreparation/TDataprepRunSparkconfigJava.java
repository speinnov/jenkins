package org.talend.designer.codegen.translators.talenddatapreparation;
...
public class TDataprepRunSparkconfigJava
{
  protected static String nl;
  public static synchronized TDataprepRunSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDataprepRunSparkconfigJava result = new TDataprepRunSparkconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_92 = "                            " + NL + "        org.apache.avro.generic.IndexedRecord record = this.function.apply(";
  protected final String TEXT_93 = ");" + NL + "        if(record != null) {" + NL + "            for (org.apache.avro.Schema.Field field : record.getSchema().getFields()) {";
  protected final String TEXT_94 = NL + "                ";
  protected final String TEXT_95 = ".put(field.pos(), record.get(field.pos()));" + NL + "            }";
  ...
  protected final String TEXT_104 = NL + NL + "java.util.function.Function<org.apache.avro.generic.IndexedRecord, org.apache.avro.generic.IndexedRecord> function_";
  protected final String TEXT_105 = " = new org.talend.dataprep.actions.DefaultActionParser(";
  protected final String TEXT_106 = ", ";
  protected final String TEXT_107 = ", decryptedPassword_";
  protected final String TEXT_108 = ").parse(";
  protected final String TEXT_109 = ", ";
  protected final String TEXT_110 = ");";
  protected final String TEXT_111 = NL;
  protected final String TEXT_112 = " rdd_";
  protected final String TEXT_113 = " = rdd_";
  protected final String TEXT_114 = ".";
  protected final String TEXT_115 = "(new ";
  protected final String TEXT_116 = "(job, function_";
 ...
 */
class TDataprepRunUtil extends org.talend.designer.common.TransformerBase {

    public TDataprepRunUtil(INode node,
    ...
    stringBuffer.append(getRowTransform().getCodeToAddToOutput(null == getOutConnMain(), new java.util.ArrayList<IMetadataColumn>()));
...
final String url = ElementParameterParser.getValue(node, "__URL__");
final String preparationId = ElementParameterParser.getValue(node, "__PREPARATION_ID__");
final String versionId = ElementParameterParser.getValue(node, "__VERSION_ID__");
final String username = ElementParameterParser.getValue(node, "__USERNAME__");
final String encoding = ElementParameterParser.getValue(node, "__ENCODING__");
final String passwordFieldName = "__PASSWORD__";
...
final TDataprepRunUtil tDataprepRunUtil = new TDataprepRunUtil(
        node, codeGenArgument, sparkTransformUtil);
org.talend.designer.spark.generator.FunctionGenerator functionGenerator = new DataprepFunctionGenerator(tDataprepRunUtil, sparkFunction);
functionGenerator.init(node, cid, null, tDataprepRunUtil.getInConnName(), null, tDataprepRunUtil.getOutConnMainName());
    ...
    stringBuffer.append(("".equals(versionId)) ? "null" : "\"" + versionId + "\"");
    stringBuffer.append(TEXT_110);
    stringBuffer.append(TEXT_111);
    stringBuffer.append(sparkFunction.getConfigReturnedType(tDataprepRunUtil.getOutConnMainTypeName()));
    stringBuffer.append(TEXT_112);
    stringBuffer.append(tDataprepRunUtil.getOutConnMainName());
    stringBuffer.append(TEXT_113);
    stringBuffer.append(tDataprepRunUtil.getInConnName());
