...
public class TDataprepRunSparkcodeJava
{
  protected static String nl;
  public static synchronized TDataprepRunSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDataprepRunSparkcodeJava result = new TDataprepRunSparkcodeJava();
    nl = null;
    return result;
  }
...
sparkTransformUtil.setFunctionGenerator(functionGenerator);
functionGenerator.generate();
